...
__________________________________________________________________________________________________
building_info_inputs (InputLaye [(None, 7)]          0                                            
__________________________________________________________________________________________________
target_time_info_inputs (InputL [(None, 11)]         0                                            
__________________________________________________________________________________________________
time_series_inputs (InputLayer) [(None, 168, 12)]    0                                            
__________________________________________________________________________________________________
building_num_layer (BuildingNum (None, 10)           600         building_num_inputs[0][0]        
__________________________________________________________________________________________________
building_info_layer (BuildingIn (None, 32)           672         building_info_inputs[0][0]       
__________________________________________________________________________________________________
target_time_info_layer (TargetT (None, 32)           736         target_time_info_inputs[0][0]    
__________________________________________________________________________________________________
