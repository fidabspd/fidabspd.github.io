...
그렇게 시작된 **오렌지가 되어버린 침착맨의 '55도발 왜 하냐고'** 만들기 <!--more-->
...
프레임 자체를 결측값으로 바라본다면, 손이 얼굴을 가리기 직전과 직후의 사진으로 적당한 interpolation을 통해 가장 간단하게 해결할 수 있을 것으로 보인다.  
다만 이렇게 하면 퀄리티는 보장하기 힘들 것이고... 하나의 프레임안에서 정확히 가려진 부분만 어떤 형태인지 알아내기 위해서는 좀 더 복잡한 과정이 필요하겠다.
