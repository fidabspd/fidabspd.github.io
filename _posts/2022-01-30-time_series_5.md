...
[Multi-Task Learning 시계열 모델 1부](https://fidabspd.github.io/2022/01/28/time_series_4.html)에 이은 2부.  
...
[Multi-Task Learning 시계열 모델 (1)](https://fidabspd.github.io/2022/01/28/time_series_4.html)에서 train, valid, test Dataset을 만드는 것까지 마쳤으며 그에 바로 이어지는 내용이다.
